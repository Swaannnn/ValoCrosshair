...
const Tooltip = ({ children, content, color = 'white', position = 'top' }: TooltipProps) => {
    ...
    const getPositionStyle = () => {
        ...
        case 'top-left':
            return { ...base, bottom: '100%', right: '0', marginBottom: '0.5rem' }
        case 'top-right':
            return { ...base, bottom: '100%', left: '0', marginBottom: '0.5rem' }
        case 'left':
